...
""",
    ...
    def test_required_work_item_tracking_fails_for_actionable_lane_without_locator(self) -> None:
        repo, temporary = self.make_registered_active_repo()
        self.addCleanup(temporary.cleanup)
        ...
        self.assertIn(
            "P42: actionable lane requires at least one work-item locator",
            report["problems"],
        )
    ...
    def test_required_work_item_tracking_accepts_compact_locator(self) -> None:
        ...
        self.git(repo, "add", "docs/dev/active-lanes.yaml")
        self.git(repo, "commit", "-q", "-m", "Link work item")
