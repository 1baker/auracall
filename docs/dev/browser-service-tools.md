...
[`packages/browser-service/src/browserTools.ts`](../../packages/browser-service/src/browserTools.ts).
...
[`scripts/browser-service/`](../../scripts/browser-service/README.md)
...
- generic browser-service work: [browser-service-upgrade-backlog.md](browser-service-upgrade-backlog.md)
- lessons review: [browser-service-lessons-review-2026-03-30.md](browser-service-lessons-review-2026-03-30.md)
- Aura-Call-only workflow work: [auracall-browser-onboarding-backlog.md](auracall-browser-onboarding-backlog.md)

Current DOM-drift extraction priorities live in the 2026-03-28 section of
[browser-service-upgrade-backlog.md](browser-service-upgrade-backlog.md):
- `navigateAndSettle(...)`
