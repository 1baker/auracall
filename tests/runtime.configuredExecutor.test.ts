...
describe('configured stored-step executor', () => {
  ...
  it('reattaches recovered stranded ChatGPT steps to the submitted tab instead of replaying the prompt', async () => {
    ...
    const reattachAgentBrowserBrokerTabImpl = vi.fn(async () => ({
      ...
      acquisitionEvidence: 'broker_inventory' as const,
      baseUrl: 'http://127.0.0.1:47777',
      browserId: brokerHandle.browserId,
      browserProcessId: 41234,
      canonicalTargetId: brokerHandle.targetId,
      chromeHost: '127.0.0.1',
      chromePort: 49505,
      ...
      requestedUrl: brokerHandle.url,
      serviceTabHandle: brokerHandle,
      sessionName: brokerHandle.sessionName,
      tabReconciliation: 'preserved_selection_only' as const,
    }));
              ...
              payload: {
                runtimeEvidence: {
                  ...
                  details: {
                    ...
                    agentBrowserAcquisitionDecision: 'opened_new_tab',
                    agentBrowserAcquisitionEvidence: 'service_response',
                    agentBrowserBaseUrl: 'http://127.0.0.1:46515',
                    agentBrowserBrowserId: brokerHandle.browserId,
                    agentBrowserCanonicalTargetId: brokerHandle.targetId,
                    agentBrowserExactUrlTargetCount: 1,
                    agentBrowserProcessId: 41234,
                    agentBrowserProfileId: brokerHandle.profileId,
                    agentBrowserRequestedUrl: brokerHandle.url,
    ...
    expect(runtimeEvidenceHeartbeat).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        details: expect.objectContaining({
          ...
          tabUrl: 'https://chatgpt.com/c/recovered-chat',
          conversationId: 'recovered-chat',
          agentBrowserAcquisitionDecision: 'retained_restart_reattach',
          agentBrowserAcquisitionEvidence: 'broker_inventory',
          agentBrowserBaseUrl: 'http://127.0.0.1:47777',
          agentBrowserBrowserId: brokerHandle.browserId,
          agentBrowserCanonicalTargetId: brokerHandle.targetId,
          agentBrowserExactUrlTargetCount: 2,
          agentBrowserProcessId: 41234,
          agentBrowserProfileId: brokerHandle.profileId,
          agentBrowserRequestedUrl: brokerHandle.url,
          agentBrowserServiceTabHandle: brokerHandle,
